...
- Removed unused prop from charts

### Fixed

- Fixed chrome notifications not showing right icon
- Fixed alerts not get dismissed in realtime
- Fixed typos in font source
- Fixed recharts not rendering elements correctly when nested
