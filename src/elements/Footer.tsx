        ...
        <footer>
          ...
          <div className="dev">
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 33.13 28.47"
                className="logo"
              >
                <path d="M16.54,17.03l3.36,5.75-3.36,5.69L0,0h5.34c.83,0,1.59.44,2,1.15l9.19,15.88Z M33.13,0l-9.06,15.53h0l-.31.57-3,5.18-3.36-5.75L25.78,1.15c.41-.71,1.17-1.15,2-1.15h5.35Z" />
              </svg>
            </a>
          </div>
        </footer>
